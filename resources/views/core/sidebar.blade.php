<div class="sidebar">
  <nav class="sidebar-nav">
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('userdetails') }}"><i class="icon-speedometer"></i> User Details </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ url('redeem-details') }}"><i class="icon-speedometer"></i> Redeem Details </a>
      </li>
      <!-- <li class="nav-title">
        UI Elements
      </li>
