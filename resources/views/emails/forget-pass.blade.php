            ...
            <td align="center" valign="top">
                ...
                <table style="margin: 0 auto;width: 100%;text-align: center;font-size: 16px; border: #50e1ed solid 4px;" cellpadding="0" cellspacing="0" class="force-full-width">
                        ...
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="90%">
                          <tr>
                            <td style="color: #000000;font-size: 17px;">
                              ...
                              <p>Please click on the following link to updated your password</p><br>
                            </td>
                          </tr>
                        </table>
                      </center>
                  ...
                  <tr>
                    <td>
                      <div>
                        <a href="{{url('/api/v1/user/reset-password',$userId)}}"
                      style="color:#000000;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Click To Reset Password</a>
                        </div>
                      <br>
                      <br>
                    </td>
